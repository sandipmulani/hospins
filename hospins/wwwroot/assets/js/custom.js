...
$("#customsearch").on('change', function(){
   mydatatable.ajax.reload();  
        ...
        //    demoModeOne(); e.preventDefault();
        //});

        $('.btn-danger').on('click', function (e) { demoModeOne(); e.preventDefault(); });



 });

 function demoModeOne(){"use strict";toastr["error"]('You Are In Demo Mode');}
        "use strict";
...
function demo_mode() {
 toastr["error"]('You Are In Demo Mode');
}
